...
try {
	...
	$ProgressPreference = "SilentlyContinue"
    Invoke-WebRequest -Uri "https://github.com/HackerHarvey/Remotely/releases/latest/download/Remotely_Server_Win-x64.zip" -OutFile "$env:TEMP\Remotely_Server_Win-x64.zip"
    $ProgressPreference = "Continue"
